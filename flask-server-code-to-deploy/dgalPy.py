# This code file was produced by Dr. Alexander Brodsky
# at George Mason University.
# It is used in the implementation of a recommendation system
# in our group project for the course CS 787 ("Decision Guidance Systems")
# like so:
# to find optimal values for yearly contributions
# and asset allocations for retirement investment accounts.
